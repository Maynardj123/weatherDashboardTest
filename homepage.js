...
function getCurrent(currentData) {
  ...
  temp.textContent = ((currentData.list[0].main.temp - 273.15) * 9 / 5 + 32).toFixed(2) + "°F";
...
searchbtn.addEventListener('click', function (event) {
  ...
  //if inputValue doesn't exist in cityArray
  if (cityArray.indexOf(inputValue) == -1) {
    console.log('HELLO')
    //then push inputValue to cityArray
